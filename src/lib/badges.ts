...
export const BADGE_MAP: Record<string, { name: string; url: string; city?: string }> = {
  ...
  // Chefchaouen
  '98b50e2d-dc99-43ef-b387-052637738c01': { name: 'Khalkhal Mawj', url: 'Khalkhal%20Mawj.png', city: 'Chefchaouen' },
  ...
  '98b50e2d-dc99-43ef-b387-052637738c05': { name: 'Mdama bahar', url: 'Mdama%20bahar.png', city: 'Chefchaouen' },
  // Fès
  ...
  '550e8400-e29b-41d4-a716-44665544f555': { name: 'Sertia Atlantik', url: 'Sertia%20Atlantik.png', city: 'Fès' },
  // Marrakech
  ...
  '98b50e2d-dc99-43ef-b387-052637738a04': { name: 'Tazrabt Sahara', url: 'Tazrabt%20Sahara.png', city: 'Marrakech' },
...
export const getBadgeUrl = (url: string) => `https://rydmefudpczpxrresflx.supabase.co/storage/v1/object/public/badges/${encodeURIComponent(url)}`;
