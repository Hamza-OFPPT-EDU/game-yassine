...
export const CITIES: City[] = [
  {
    ...
    points: 500,
    image: '/assets/images/cities_illustrations/Rabat/1775865430897-hz5t79e38xk-compressed (1).jpg',
    status: 'completed',
    stepNum: 1,
    totalSteps: 4,
  },
  {
    ...
    points: 300,
    image: '/assets/images/cities_illustrations/Chefchaouen/chefchaoun - uliistration (1).jpg',
    status: 'completed',
    stepNum: 1,
    totalSteps: 4,
  },
  {
    ...
    points: 450,
    image: '/assets/images/cities_illustrations/Fes/1775897948311-n36zgyweqeq-compressed (1).jpg',
    status: 'active',
    stepNum: 3,
    totalSteps: 10,
  },
  {
    ...
    points: 400,
    image: '/assets/images/cities_illustrations/Marrakech/1775866461317-lgr7dl7gvb (1).jpg',
    status: 'active',
    stepNum: 1,
    totalSteps: 15,
  },
  {
    ...
    name: 'Laâyoune',
    arabicName: 'العيون',
    description: 'Ishaq crée des protocoles d’urgence, une coopérative, une santé décentralisée, des innovations frugales et un plan de développement.',
    arabicDescription: 'يبتكر إسحاق بروتوكولات الطوارئ، تعاونية، صحة لامركزية، ابتكارات مقتصدة وخطة تنموية.',
    focus: 'Création & Innovation Frugale',
    points: 500,
    image: '/assets/images/cities_illustrations/Laayoune/Laayoune illustration  (2).png',
    status: 'locked',
    stepNum: 0,
    totalSteps: 5,
  },
  {
    ...
    name: 'Dakhla',
    arabicName: 'الداخلة',
    description: 'Ishaq maîtrise mer, biologie, économie circulaire, énergie éolienne et vision intégrée pour devenir un leader accompli.',
    arabicDescription: 'يتقن إسحاق البحر، علم الأحياء، الاقتصاد الدائري، طاقة الرياح والرؤية المتكاملة ليصبح قائداً متمكناً.',
    focus: 'Maîtrise & Synthèse Holistique',
    points: 500,
    image: '/assets/images/cities_illustrations/Dakhla/1775912215516-390zqh5fuyc-compressed (1).jpg',
    status: 'locked',
    stepNum: 0,
    totalSteps: 5,
  },
