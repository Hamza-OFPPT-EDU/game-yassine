export const RABAT_EXPLANATIONS: Record<string, any> = {
  "Rabat": {
    "R1": {
      "titre": "URGENCES À L’HÔPITAL IBN SINA",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "R2": {
      "titre": "MINISTÈRE & PRISE DE DÉCISION",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "R3": {
      "titre": "PROJET COLLABORATIF À L’UNIVERSITÉ",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "R4": {
      "titre": "ONG ESPOIR MAROC – ENTREPRENEURIAT SOCIAL",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "R5": {
      "titre": "LE GRAND DÉFI FINAL – WILAYA",
      "exercices": {
        "1": {
          "type": "Prise de décision",
...
export const CHEFCHAOUEN_EXPLANATIONS: Record<string, any> = {
  "Chefchaouen": {
    "C1": {
      "titre": "RANDONNÉE AU PARC TALASSEMTANE",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "C2": {
      "titre": "COOPÉRATIVE TISSEUSE DU RIF",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "C3": {
      "titre": "LE SOUK ET LE RESTAURANT",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "C4": {
      "titre": "L’HERBORISTERIE DE LA RÉSILIENCE",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "C5": {
      "titre": "LE FESTIVAL – DÉFI FINAL CHEFCHAOUEN",
      "exercices": {
        "1": {
          "type": "Prise de décision",
...
export const FES_EXPLANATIONS: Record<string, any> = {
  "Fès": {
    "F1": {
      "titre": "L’ATELIER DE CALLIGRAPHIE",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "F3": {
      "titre": "L’UNIVERSITÉ – PRISE DE DÉCISION ANALYTIQUE",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "F4": {
      "titre": "RESTAURATION DE LA MEDERSA BOU INANIA",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "F5": {
      "titre": "LE FESTIVAL – DÉFI FINAL FÈS",
      "exercices": {
        "1": {
          "type": "Prise de décision",
...
export const MARRAKECH_EXPLANATIONS: Record<string, any> = {
  "Marrakech": {
    "M1": {
    ...
    "M2": {
      "titre": "LE RIAD DE LUXE – LEADERSHIP INTERCULTUREL",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "M3": {
      "titre": "LE SOUK SEMMARINE – ÉVALUATION COMMERCIALE",
      "exercices": {
        "1": {
          "type": "QCM",
    ...
    "M4": {
      "titre": "L’ÉVÉNEMENTIEL SOUS PRESSION",
      "exercices": {
        "1": {
          "type": "Prise de décision",
    ...
    "M5": {
      "titre": "LE SOMMET INTERNATIONAL – DÉFI FINAL MARRAKECH",
      "exercices": {
        "1": {
          "type": "Prise de décision",
...
export const LAAYOUNE_EXPLANATIONS: Record<string, any> = {
  "Laâyoune": {
    "L1": {
      "titre": "LA BASE DU DÉSERT – CRÉATION SOUS CONTRAINTE EXTRÊME",
      "exercices": {
        "1": {
    ...
    "L2": {
      "titre": "LA COOPÉRATIVE DES FEMMES DU DÉSERT",
      "exercices": {
        "1": {
          "type": "QCM créatif",
    ...
    "L4": {
      "titre": "LA FERME SOLAIRE – INNOVATION FRUGALE",
      "exercices": {
        "1": {
          "type": "Prise de décision créative",
    ...
    "L5": {
      "titre": "LE PLAN DE DÉVELOPPEMENT – DÉFI FINAL LAÂYOUNE",
      "exercices": {
        "1": {
...
export const DAKHLA_EXPLANATIONS: Record<string, any> = {
  "Dakhla": {
    "D1": {
      "titre": "LE PORT DE PÊCHE – LEADERSHIP NATUREL",
      "exercices": {
        "1": {
        ...
        "2": {
          "type": "Scénario en cascade",
          "explication": "Gérer un naufrage imminent par triage immédiat, signalisation créative et soutien moral. Indication : Q1 → répartir les gilets selon les capacités de nage ; Q2 → utiliser miroir + feu + chiffon imbibé ; Q3 → rassurer par un récit collectif."
        },
        "3": {
          "type": "Rôles d’équipe",
          "explication": "Attribuer les rôles Belbin intuitivement (capitaine, mécanicien, météorologue, trappeur, médiateur). Indication : Chaque force au service du groupe : le plus expérimenté comme capitaine, le manuel comme mécanicien, l’analyste comme météorologue, le créatif comme trappeur, l’apaisant comme médiateur."
        },
        "4": {
          "type": "Texte à trous (création)",
          "explication": "Synthétiser la sagesse maritime en maximes. Indication : Inspirez-vous des piliers de Cyrulnik, de Selye et de Frankl pour formuler des principes simples et mémorables (ex : la mer enseigne, l’équipage qui rit tangue moins, la tempête passe)."
        },
        "5": {
          "type": "Dialogue de maîtrise",
          "explication": "Pratiquer la CNV incarnée en three phrases naturelles. Indication : Dire « Stop. On respire. Chacun raconte sa version sans s’interrompre. Ensuite, on partage la prise. »"
        },
        "6": {
          "type": "Détection d’erreurs instantanée",
          "explication": "Repérer les failles d’un plan de sécurité maritime. Indication : Gilets non vérifiés, radio sans batterie de secours, pas de signal visuel, eau insuffisante, absence de formation, pas de point de ralliement."
        },
        "7": {
          "type": "Contre-la-montre",
          "explication": "Prendre 4 micro-décisions rapides en mer (homme à la mer, moteur en feu, blessé inconscient, épuisement). Indication : Homme à la mer → bouée + guetteur + approche lente ; moteur en feu → couper essence + couverture anti-feu ; blessé → PLS ; épuisé → passer la barre."
        },
        "8": {
          "type": "Classement",
          "explication": "Classer instinctivement les priorités de survie en mer. Indication : L’intuition du marin place le gilet d’abord, puis le radeau, l’eau, la radio balise, le miroir, la nourriture, le moteur, les cartes, et enfin les cigarettes et la bière en dernier."
        },
        "9": {
          "type": "Réponse courte",
          "explication": "Rédiger un rapport d’incident complet (analyse, causes, leçons). Indication : Décrivez les faits, identifiez les causes immédiates et systémiques, proposez des améliorations concrètes (équipement, formation, protocole)."
        },
        "10": {
          "type": "Puzzle/Énigme",
          "explication": "Identifier la sagesse maritime (la maîtrise). Indication : « Je ne résiste pas à la tempête, je m’incline pour ne pas casser. Capitaine Aziz est mon visage, Ishaq est devenu mon reflet. »"
        }
      }
    },
    "D2": {
      "titre": "LA STATION DE BIOLOGIE MARINE",
      "exercices": {
        "1": {
        ...
        "2": {
          "type": "Scénario en cascade",
          "explication": "Analyser une marée verte en trois questions, proposer des solutions systémiques et anticiper leurs effets secondaires. Indication : Q1 → origine, concentration, tendance ; Q2 → réduire les nitrates à la source + récolter les algues pour biogaz ; Q3 → bruit, transport, entretien des filtres."
        },
        "3": {
          "type": "Rôles d’équipe",
          "explication": "Attribuer les rôles Belbin à des scientifiques (leader, analyste, créatif, réalisateur, harmonisateur, expert). Indication : Directeur de labo → leader ; statisticien → analyste ; modélisateur → créatif ; technicien de terrain → réalisateur ; gestionnaire de projet → harmonisateur ; vieux biologiste → expert."
        },
        "4": {
          "type": "Détection d’erreurs",
          "explication": "Identifier 7 boucles de rétroaction négatives dans un projet de tourisme de masse. Indication : Pollution → dégradation → moins de touristes ; béton → moins de plage ; épuisement eau → fermeture piscines ; bruit → départ faune ; emplois précaires → turnover ; déchets → nuisibles ; trafic → insatisfaction."
        },
        "5": {
          "type": "Texte à trous",
          "explication": "Compléter un schéma systémique (causes et effets circulaires). Indication : Phytoplancton → poissons → oiseaux → nutriments → phytoplancton. La destruction d’un maillon casse la boucle."
        },
        "6": {
          "type": "Dialogue",
          "explication": "Intégrer les intérêts écologiques et économiques dans un argumentaire (gagnant-gagnant). Indication : Proposer un hôtel éco-conçu, une certification verte, et un fonds de 5% des bénéfices pour la protection de la lagune."
        },
        "7": {
          "type": "Contre-la-montre",
          "explication": "Diagnostiquer rapidement 4 micro-écosystèmes (dune, oiseaux, algues, eau chaude). Indication : Dune → disparition des plantes fixatrices ; oiseaux → disparition de leurs proies (insectes) ; algues → nitrates excédentaires ; eau chaude → moins d’oxygène, mortalité."
        },
        "8": {
          "type": "Classement",
          "explication": "Classer les facteurs de résilience d’un écosystème (diversité, connectivité, redondance…). Indication : La diversité est la première assurance-vie, puis la connectivité, la redondance, la taille de population, la capacité de reproduction, etc. La température est en dernier."
        },
        "9": {
          "type": "Réponse courte",
          "explication": "Rédiger un plan systémique de restauration de lagune (multi-causes, actions emboîtées). Indication : Agir sur les sources de pollution (nitrates), restaurer les herbiers, réintroduire des espèces, mettre en place un suivi participatif."
        },
        "10": {
          "type": "Puzzle/Énigme",
          "explication": "Identifier la pensée systémique (Senge). Indication : « Je ne vois pas l’arbre, je vois la forêt. Je ne vois pas la vague, je vois l’océan. Nadia m’a apprise, Ishaq m’a incarnée. »"
        }
      }
    },
    "D3": {
      "titre": "LA FERME D’ALGUES – ÉCONOMIE CIRCULAIRE",
      "exercices": {
        "1": {
          "type": "QCM maîtrise",
        ...
        "2": {
          "type": "Scénario en cascade",
          "explication": "Créer une boucle circulaire face à une pénurie d’engrais. Indication : Q1 → compost d’algues, fientes de volaille, résidus de poisson ; Q2 → déchets de poisson → engrais pour algues ; algues → aliment volaille ; fientes → engrais ; Q3 → argument économique (économies 40%)."
        },
        "3": {
          "type": "Rôles d’équipe",
          "explication": "Attribuer les rôles Belbin en tenant compte des interdépendances. Indication : Leader (coordinateur), Analyste (contrôle qualité), Créatif (innovation produit), Réalisateur (exploitation), Harmonisateur (relations fournisseurs/clients), Expert technique (algoculture)."
        },
        "4": {
          "type": "Détection + création",
          "explication": "Transformer les failles d’un modèle linéaire en alternatives circulaires. Indication : Déchets → valorisation ; énergie fossile → solaire ; mono-culture → polyculture ; eau perdue → recyclage ; transport lointain → circuit court ; obsolescence → réparation."
        },
        "5": {
          "type": "Texte à trous",
          "explication": "Illustrer les 7 principes de l’économie circulaire avec des exemples concrets. Indication : Zéro déchet → compost ; énergie renouvelable → panneaux solaires ; conception modulaire → bassins extensibles ; proximité → clients locaux ; réparation → maintenance interne ; partage → mutualisation d’outils ; éco-conception → emballages biodégradables."
        },
        "6": {
          "type": "Dialogue",
          "explication": "Convaincre un banquier avec un double argument (ROI écologique + financier). Indication : « 2M DH remboursables en 5 ans. ROI écologique : économie d’eau 70%, zéro déchet. ROI financier : marge doublée par le label éco-circulaire. »"
        },
        "7": {
          "type": "Contre-la-montre",
          "explication": "Prendre 4 micro-décisions commerciales (refus client, concurrence, délai paiement, hausse fournisseur). Indication : Client trop cher → lot plus petit + échantillon ; concurrence prix → miser sur la certification ; délai 90 jours → petit intérêt + première livraison payée ; hausse 30% → alternative locale + négociation volume."
        },
        "8": {
          "type": "Classement",
          "explication": "Classer des actions RSE par triple impact (social, environnemental, économique). Indication : Réduction des déchets (triple), énergie renouvelable, sécurité travailleurs, égalité salariale, formation continue, achats locaux, mécénat, bilan carbone."
        },
        "9": {
          "type": "Réponse courte",
          "explication": "Évaluer une ferme avec des indicateurs intégrés (profit, personnes, planète). Indication : Indicateurs : marge nette, nombre d’emplois locaux, réduction des déchets, consommation d’eau, empreinte carbone, satisfaction des employés."
        },
        "10": {
          "type": "Puzzle/Énigme",
          "explication": "Identifier l’économie circulaire. Indication : « Je transforme le déchet en ressource, la contrainte en opportunité. Je ne jette rien, je transforme tout. Younès m’a bâtie, Ishaq m’a comprise. »"
        }
      }
    },
    "D4": {
      "titre": "LE PARC ÉOLIEN – ÉNERGIE INVISIBLE",
      "exercices": {
        "1": {
          "type": "QCM maîtrise",
        ...
        "2": {
          "type": "Scénario en cascade",
          "explication": "Gérer une panne générale par diagnostic terrain, décision prudente et communication transparente. Indication : Q1 → vérifier disjoncteurs, pales, câbles ; Q2 → arrêter (l’îlotage est risqué) ; Q3 → annoncer panne 4h, groupes de secours pour hôpitaux, remercier pour la patience."
        },
        "3": {
          "type": "Rôles d’équipe",
          "explication": "Attribuer 5 fonctions à 5 techniciens (sécurité, technique, logistique, relations, innovation). Indication : Sécurité → expert protocole ; Technique → plus expérimenté ; Logistique → approvisionnement ; Relations → liaison riverains ; Innovation → améliorations process."
        },
        "4": {
          "type": "Détection d’erreurs",
          "explication": "Trouver 7 failles dans un protocole de sécurité obsolète (Reason). Indication : Absence de double vérification, gants inadaptés, échelles non certifiées, pas de balisage, pas de téléphone satellite, formation annuelle trop rare, absence de retour d’expérience."
        },
        "5": {
          "type": "Texte à trous",
          "explication": "Compléter la métaphore des 5 vents de l’innovation. Indication : Vent stratégique (vision long terme), technique (R&D), social (acceptation), économique (financement), environnemental (bilan carbone)."
        },
        "6": {
          "type": "Dialogue",
          "explication": "Résoudre un conflit pêcheurs vs éoliennes par une solution technique et sociale. Indication : Technique : pose différée (période de reproduction) + gainage lisse ; Social : comité de suivi pêcheurs + électriciens + compensation indexée sur les captures."
        },
        "7": {
          "type": "Contre-la-montre",
          "explication": "Prendre 4 micro-urgences énergétiques (surtension, incendie, chute de pale, cyberattaque). Indication : Surtension → couper lignes non critiques ; incendie → couper alimentation + pompiers + périmètre ; chute de pale → arrêt total + inspection + message rassurant ; cyberattaque → mode manuel local + isolement + audit."
        },
        "8": {
          "type": "Classement",
          "explication": "Prioriser des technologies pour Dakhla (solaire, éolien, hydrolien, biomasse, stockage, etc.). Indication : 1. solaire (abondant), 2. éolien (vent régulier), 3. hydrolien (courant), 4. biomasse (algues), 5. stockage batterie, 6. réseau intelligent, 7. énergie marémotrice, 8. géothermie peu profonde, 9. hydrogène vert, 10. nucléaire (hors contexte)."
        },
        "9": {
          "type": "Réponse courte",
          "explication": "Rédiger un plan énergie Dakhla 2040 (100% renouvelable, intégré au développement local). Indication : Mentionner le mix solaire/éolien, le dessalement par excédent solaire, les fermes hydroponiques, le tourisme zéro déchet, l’économie bleue, l’université des océans."
        },
        "10": {
          "type": "Puzzle/Énigme",
          "explication": "Identifier le vent (ressource ancienne et moderne). Indication : « Je souffle sans visage, je déplace les montagnes de sable, je remplis les voiles, je fais tourner les pales. Fatima-Zahra m’a domestiqué, Ishaq m’a compris. »"
        }
      }
    },
    "D5": {
      "titre": "LE PALAIS DES CONGRÈS – MAÎTRISE ABSOLUE",
      "exercices": {
        "1": {
        ...
        "2": {
          "type": "Scénario en cascade",
          "explication": "Défendre le plan face à l’opposition (preuves terrain, financement mixte, acceptation réelle). Indication : Q1 → citer les réussites existantes (ferme d’algues, parc éolien, école) ; Q2 → l’inaction coûte plus cher, financement mixte ; Q3 → 65% de riverains favorables après électricité gratuite, femmes d’Aicha déjà engagées."
        },
        "3": {
          "type": "Rôles d’équipe",
          "explication": "Créer un organigramme de gouvernance en binômes ville/compétence. Indication : Stratégique : Wali Benkirane + Gouverneur Amrani ; Énergie & Eau : Brahim + Fatima-Zahra ; Économie bleue : Capitaine Aziz + Younès ; Social & Éducation : Aicha + Nadia ; Financement : Hicham + Pr. Latifa."
        },
        "4": {
          "type": "Détection d’erreurs",
          "explication": "Réfuter 10 critiques en une phrase chacune, en mobilisant les mentors comme preuves vivantes. Indication : Exemples : Solaire ne produit pas la nuit → avec éolien complémentarité ; Dessalement trop énergivore → alimenté par excédent solaire ; Algoculture non rentable → prouvée par Younès ; etc."
        },
        "5": {
          "type": "Texte à trous",
          "explication": "Compléter les 10 commandements du leadership maître (synthèse des 6 villes). Indication : calme, intuition, systèmes, parties prenantes, création, adaptation, silence, présence, confiance, humour."
        },
        "6": {
          "type": "Dialogue final",
          "explication": "Rédiger un discours de clôture structuré (synthèse par ville, remerciements des mentors, leçons, promesse de transmission). Indication : Citez chaque ville avec un verbe (connaître, appliquer, analyser, évaluer, créer, maîtriser), remerciez les 30 mentors, terminez par l’engagement à transmettre."
        },
        "7": {
          "type": "Contre-la-montre ultime",
          "explication": "Répondre instinctivement à 6 questions (une par ville) en 30 secondes chacune. Indication : Les réponses sont les acquis antérieurs : stress aigu (Rabat), STOP (Chefchaouen), analyse systémique (Fès), évaluation multicritère (Marrakech), création frugale (Laâyoune), maîtrise (Dakhla)."
        },
        "8": {
          "type": "Classement",
          "explication": "Classer les 6 niveaux de Bloom (connaître, appliquer, analyser, évaluer, créer, maîtriser) et justifier. Indication : On ne peut créer sans connaître, sans pratiquer, sans analyser, sans évaluer. La maîtrise intègre tout."
        },
        "9": {
          "type": "Réponse courte",
          "explication": "Écrire une lettre d’Ishaq à son père (bilan émotionnel et professionnel). Indication : Soyez sincère, mentionnez les moments clés (tempête, conflit, recadrage, innovation), exprimez la fierté et la gratitude, ouvrez sur l’avenir."
        },
        "10": {
          "type": "Puzzle/Énigme ultime",
          "explication": "Identifier la compétence intégrée, incarnée, maîtrisée. Indication : « Je suis le fruit de 6 arbres. J’ai visité Rabat, Chefchaouen, Fès, Marrakech, Laâyoune, Dakhla. Les autres te l’ont enseigné, mais maintenant je t’appartiens. Ce qui reste quand tu as tout appris et tout oublié. »"
        }
      }
    }
  }
