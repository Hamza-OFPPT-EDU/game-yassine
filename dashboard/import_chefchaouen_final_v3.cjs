      ...
      questions: [
        {
          ...
          neg: 'Crier ou courir aggrave la panique. Restez calme et respirez avec lui.'
        },
        {
          type: 'Appariement',
  ...
  for (const mData of missionsData) {
    ...
    const questionsToInsert = questions.map((q, idx) => {
      ...
      if (type === 'scenario_cascade') {
        questionData.options = q.options; // Assuming it matches the structure expected by the app
      }
